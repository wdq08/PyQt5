...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(50, 300, 400, 50))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.pushButton.setGeometry(QtCore.QRect(50, 210, 400, 70))
        font = QtGui.QFont()
        ...
        # Set default choosed radio button
        self.radioButton.setChecked(True)


    def select(self):
        if self.radioButton.isChecked():
            self.label.setText(f'You choosed {self.radioButton.text()}!!!')
        if self.radioButton_2.isChecked():
            self.label.setText(f'You choosed {self.radioButton_2.text()}!!!')
            # Set tht text
            self.radioButton_2.setText("choosed")
        if self.radioButton_3.isChecked():
            self.label.setText(f'You choosed {self.radioButton_3.text()}!!!')
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Pick Your Topping"))
